...
<ThemePreview title="Everforest Light Hard" background="#f2efdf" foreground="#5c6a72" cursor="#f57d26" selection="#f0f2d4" ansi="#7a8478, #e67e80, #9ab373, #ceaf72, #7fbbb3, #d699b6, #83c092, #b2af9f, #a6b0a0, #f85552, #8da101, #dfa000, #3a94c5, #df69ba, #35a77c, #fffbef" cursorText="#f0f2d4" selectionText="#5c6a72" />
...
<Steps>
  <Step title="Install the extension">
    In Phantom, open the Extensions pane in the sidebar (or Settings → Extensions) and press **Install** next to Everforest Light Hard.
  </Step>
  ...
  <Step title="Pick Everforest Light Hard">
...
The whole extension is `themes/everforest-light-hard.conf`. It is a Ghostty theme file: one `key = value` per line, `#` for comments, and colour keys only. This one sets 22 values.
...
Settings → Extensions has a **Reveal in Finder** button. Copy `themes/everforest-light-hard.conf`, change what you want, and drop the file into your own themes folder, where Settings → Appearance lists it under **Custom Themes**.
...
Everforest Light Hard is a terminal palette. It sets the sixteen ANSI colours, the background and the foreground, and it stops there, so the window chrome and the macOS icon keep the colours the app gives them and follow the window's own appearance.
