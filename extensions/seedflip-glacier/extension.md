...
created: 2026-09-06
icon: media/icon.png
tags: [theme, light, colours, terminal, seedflip, glacier]
---

SeedFlip Glacier is a light palette: the terminal sits on `#f8fafc` and writes in `#0f172a`, a contrast ratio of 17.1:1. All 16 ANSI entries are different colours. A selection is drawn on `#ffffff`.
...
**Install** next to SeedFlip Glacier. The theme is then listed in Settings, then Appearance,
