...
| Foreground | `foreground` | `#e6edf3` |
| Cursor | `cursor-color` | `#2f81f7` |
| Cursor text | `cursor-text` | `#6fc1ff` |
| Selection background | `selection-background` | `#e6edf3` |
...
| 1 | Red | `#ff7b72` | 9 | Bright red | `#ffa198` |
